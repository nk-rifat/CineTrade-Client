...
const Error = ({ 
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-[400px] p-6 text-center border border-red-500/20 bg-red-500/5 rounded-3xl">
      <HiOutlineExclamationCircle className="text-red-500 mb-4" size={50} />
      <h3 className="text-xl font-bold text-white mb-2">Oops! Execution Error</h3>
